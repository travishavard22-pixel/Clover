...
const pairs = [
  ...
  // 4.5:1 — these tokens carry 11-12px normal-weight body text (timestamps, status chips,
  // marketplace labels), which is "normal text" under WCAG 1.4.3, not large text.
